...
| Dapper | 2.1.79 | 2.1.86 |

- Bump the redis group with 1 update `(ce7dc8c)` — dependabot[bot]
- Bump Dapper from 2.1.79 to 2.1.86 `(b4da0c4)` — dependabot[bot]

## [1.0.1-beta.16] — 2026-09-10

### 🏠 Chores

- ThunderPropagator: update version to 1.0.1-beta.15 and format package version entries `(3de25ed)` — Kiarash Minoo

## [1.0.0-beta.15] — 2026-09-06

### 📦 Dependencies

| Package | Old | New |
|---------|-----|-----|
| $(ThunderPropagatorPackageId) | $(ThunderPropagatorVersion) | 1.0.1-beta.216 |
| Asp.Versioning.Http | 10.* | 10.* |
| Microsoft.AspNetCore.Authorization | 10.* | 10.* |
| Microsoft.Extensions.Caching.Memory | 10.* | 10.* |
| Microsoft.Extensions.Diagnostics.HealthChecks | 10.* | 10.* |
| Microsoft.Extensions.Diagnostics.ResourceMonitoring | 10.* | 10.* |
| Microsoft.Extensions.ObjectPool | 10.* | 10.* |
| Npgsql | 10.* | 10.* |
| Dapper | 2.1.79 | 2.1.79 |
| MongoDB.Driver | 3.11.1 | 3.11.1 |
| StackExchange.Redis | 3.1.31 | 3.1.31 |
| Pluralize.NET.Core | 1.0.0 | 1.0.0 |
| FluentAssertions | 8.10.0 | 8.10.0 |
| Microsoft.NET.Test.Sdk | 18.9.0 | 18.9.0 |
| NSubstitute | 6.2.0 | 6.2.0 |
| NetArchTest.Rules | 1.3.2 | 1.3.2 |
| xunit | 2.9.3 | 2.9.3 |

- ThunderPropagator.RecoveryHandlers: pin ThunderPropagator version inline, regroup packages `(6647921)` — Kiarash Minoo
...
- ThunderPropagatorPackages: bump version to 1.0.1-beta.205 `(840323f)` — Kiarash Minoo

### ⚙️ CI / Tooling

- enable nuget-filter-enabled to stop publishing every platform/config package variant `(c984a0c)` — Kiarash Minoo
